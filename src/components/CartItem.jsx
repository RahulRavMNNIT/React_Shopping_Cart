...
const CartItem = ({ item }) => {
  ...
  return (
    <div className="flex flex-col itmes-center sm:flex-row justify-between p-4 sm:p-6 mb-4 bg-gray-900 rounded-xl shadow-2xl border-gray-800 transition duration-300 hover:border-orange-600/50">
      ...
      <div className="flex items-center justify-between sm:justify-end w-full sm:w-2/5 sm:mt-0 space-x-4">
        ...
        <p className="font-extrabold text-orange-300 w-24 text-right hidden mb:block">
